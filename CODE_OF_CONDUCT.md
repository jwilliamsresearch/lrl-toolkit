...
diverse, inclusive, and healthy community. We hold a particular responsibility
to the language communities whose data and heritage this project works with.
...
- Focusing on what is best for the overall community and the language
...
- Misrepresenting a model or dataset as endorsed by a language community when
  it is not
